window.speakers = [{
    ...
    },
    {
        ...
        role: "Panelist",
        topic: "Emerging Research in AI",
        cv: "Yannis Ioannidis is the President of the Association for Computing Machinery (ACM), a Professor of Informatics & Telecom at the University of Athens, and an Associated Faculty at the 'Athena' Research Center. His research interests include Database and Information Systems, Data Science and Machine Learning, Data Infrastructures, Recommender Systems and Personalization, and Interactive Digital Storytelling. His work is often interdisciplinary and inspired by and applied to data management and analysis problems that arise in industrial environments or in the context of other sciences (Social Sciences and Humanities, Life Sciences, Physical Sciences) and the Arts. He has been the coordinator and legal entity head of OpenAIRE, the technology director of EBRAINS, and the coordinator of the development of the EOSC EU Node. He is an ACM and IEEE Fellow, a member of Academia Europaea, and a recipient of several research and teaching awards. He is also a co-chair of the Global Climate Hub of the UN Sustainable Development Solutions Network (UN SDSN)."
    },
    {
