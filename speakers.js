window.speakers = [{
    ...
    },
    {
        ...
        photo: "biophotos/spyros-armostis.jpg",
    ...
    },
    {
        ...
        photo: "biophotos/panayiotis-charalambous.jpeg",
        capacity: "Research Assistant Professor, CYENS Centre of    Excellence",
        role: "Panelist",
        topic: "AI in Culture and Heritage",
        cv: "Dr. Panayiotis Charalambous is a Research Assistant Professor at the CYENS Centre of Excellence, where he leads the PULSE (formerly V-EUPNEA) research group. His work focuses on computer graphics, animation, crowd simulations, extended reality (XR), digital twins, and AI-driven technologies for digital cultural heritage and creativity. He holds a PhD in Computer Graphics and Animation from the University of Cyprus.  Dr. Charalambous has coordinated and contributed to several high-impact research projects, including Horizon 2020 initiatives such as ShareSpace, ReInherit, PREMIERE and HAMLET, as well as EHEM (JPICH), 3DMotaaS (RIF), and CHARISMA (RIF). He is the principal investigator and research lead of iNicosia, CYENSâ flagship immersive urban digital twin initiative. His research explores the intersections of computer animation, game technologies, AI for graphics, and virtual heritage, with publications in leading venues such as ACM SIGGRAPH, Eurographics, and Computer Graphics Forum."
    },
    {
        name: "Michael Chatzipanagiotis",
        photo: "biophotos/michael-chatzipanagiotis.jpg",
        capacity: "Assistant Professor, Department of Law, University of Cyprus ",
        role: "Panelist",
        topic: "AI in Critical Infrastructures",
        cv: "Michael Chatzipanagiotis is Assistant Professor in Private Law at the Department of Law of the University of Cyprus (UCY). He teaches Torts, Insurance Law, Consumer Protection, Banking Law, European Private Law and Air Law. His main research interests are Legal aspects of Artificial Intelligence (AI), Torts, Insurance Law, Consumer protection, Intellectual Property Rights (IPR), Air and Space Law, Banking Law and Alternative Dispute Resolution (ADR). He has also participated in various research and consulting projects of the European Commission on digitalisation of justice, air law, space law and consumer protection."
    },
    {
        name: "Sotirios Chatzis",
        photo: "biophotos/sotirios-chatzis.png",
    ...
    {
        name: "Yiorgos L. Chrysanthou",
        photo: "biophotos/george-chrysanthou.jpg",
        capacity: "Professor, University of Cyprus and CYENS CoE",
        role: "Session Chair",
        topic: "AI in Culture and Heritage",
    ...
    },
    {
        ...
        cv: "Andreas Demetriou is the Chief Information Officer at Alphamega Hypermarkets, where he drives the companyâs Technology Strategy, Digital Transformation, and AI initiatives. He leads the AI Coordination Team and serves on the AI Steering Committee, playing a key role in shaping the organizationâs future through intelligent systems and data-driven innovation. Under his leadership, Alphamega was recognized by IDG as one of the 100 Most Innovative Companies of 2020, thanks to its pioneering technology solutions. Andreas holds a BSc in Computer Science from the University of Crete and an MSc in Information Systems from the University of Surrey. He is also a certified GDPR Data Protection Officer, a Lead ISO 27001 Implementer (PECB), and a PMÂ² Project Management certified professional."
    },
    {
        name: "Andreas Demetriou",
        photo: "biophotos/andreas_demetriou.jpg",
    ...
    },
    {
        ...
        role: "Panelist",
        topic: "AI in Higher Education, AI in Healthcare",
        cv: "Dr Nikolaos Dietis is an Assistant Professor of Pharmacology at the University of Cyprus Medical School. Apart from his research activities in pharmacology, he is also interested in Medical Education and technology-enhanced learning, with a particular focus on the constructive use of AI in teaching & learning. He is a member of the European Commissionâs 'European AI Alliance' and the Digital Education Hub. He has received a number of awards for excellence in teaching, including the 2025 Clinical Teacher 20th Anniversary Award by the Association for the Study of Medical Education."
    },
    {
        name: "Paul Doolan",
        photo: "biophotos/paul-doolan.png",
        capacity: "Director of AI, Medical Physicist, German Medical Institute",
        role: "Panelist",
        topic: "AI in Healthcare",
        cv: "Dr Paul Doolan is the Director of AI and Medical Physicist at the German Medical Institute in Limassol, Cyprus. He leads cutting-edge deployments of AI across the hospital - from automated radiotherapy planning and AI-accelerated MRI scans to high-speed PET imaging workflows. With a PhD from University College London and research roots at Harvard and Massachusetts General Hospital, he blends deep clinical expertise with bold innovation to transform patient care through intelligent technology"
    },
    {
        name: "Constantine Dovrolis",
        photo: "biophotos/constantine-dovrolis.jpg",
        capacity: "Director of the Center for Computational Science and Technology (CaSToRC), Cyprus Institute",
        role: "Panelist",
        topic: "Emerging Research in AI, Workshop: AI Services",
    ...
    {
        name: "Sorin Hermon",
        photo: "biophotos/sorin-hermon.jpg",
    ...
    },
    {
        ...
        photo: "biophotos/panayiota-kendeou.jpg",
        capacity: "Distinguished McKnight University Professor and Guy Bond Chair in Reading in the Department of Educational Psychology at the College of Education and Human Development, University of Minnesota, USA",
        role: "Panelist",
        topic: "AI in Education: Policy and Practice",
    ...
    },
    {
        ...
        role: "Session Chair",
        topic: "AI in Cybersecurity",
        cv: "Angelos K. Marnerides is an Asst. Professor of Cyber Physical Systems Security in the Department of Electrical and Computer Engineering (ECE) and a Faculty Member at the KIOS Research and Innovation Centre of Excellence at the University of Cyprus. He holds a BSc (Honours, 2006) from Middlesex University and an MSc with Distinction (2007) as well as a PhD (2011) in Computer Science from Lancaster University. He has also held research positions at Carnegie Mellon University, University College London, University of Porto, and Lancaster University. Before joining UCY, he was a tenured Associate Professor at University of Glasgow, where he led the Glasgow Cyber Defense group. He has published 80+ publications in top-tier IEEE/ACM conferences with research focusing on secure and resilient system design with strong theoretical underpinnings and practical, data-driven implementations. He is currently the coordinator of the â¬5.8M COCOON project funded by Horizon Europe â the first EU Innovation Action project coordinated by UCY KIOS â and the â¬6.4M EU Horizon FOCAL project. He also serves as the national representative in the European Telecommunications Standards Institute (ETSI) Working Group for the Cyber Resilience Act. Angelos is a Senior Member of Institute of Electrical and Electronics Engineers (IEEE)."
    },
    {
        name: "Socrates Metaxas",
        photo: "biophotos/socrates-metaxas.jpg",
        capacity: "General Manager at the Limassol District Local Government Organization",
        role: "Panelist",
        topic: "AI in Critical Infrastructures",
        cv: "Socrates Metaxas graduated from the London School of Economics and Political Science in 1987 where he studied Economics with specialization in Industry and Trade.  He got an MBA from the City of London Business School and is a Fellow of the Institute of Chartered Accountants in England & Wales.  He served as a member of the Statistics and Economics Specialist Group of the International Water Association.  He was employed by the Water Board of Lemesos in 1993 as Head of Financial Services and from 2007 he has been the Water Board Manager. From 1st July 2024, following the reform of the local administration in Cyprus, he was appointed General Manager of the Limassol District Local Government Organisation."
    },
    {
        name: "Fereniki Panagopoulou-Koutnatzi",
        photo: "biophotos/fereniki-koutnatzi.jpg",
        capacity: "Assoc. Professor, Head of Department of Public Administration, Panteion University",
        role: "Panelist",
        topic: "AI and Challenges to Democracy",
        cv: "Dr. Fereniki Panagopoulou-Koutnatzi is Assistant Professor of Constitutional Law at the Panteion University and a Supreme-Court Lawyer. She has worked as a Legal Auditor at the Hellenic Data Protection Authority for eight years. She studied law at the National and Kapodistrian University of Athens (bachelorâs degree and postgraduate degree in public law), as well as Law and Public Health at the University of Harvard. She holds a PhD in Constitutional Law and Bioethics from the Humboldt University in Berlin. Fereniki has taught Constitutional Law, Law and New Technologies, Law of Public Health, American Law and Bioethics at the University of Berlin, the Berlin School of Economics and Law, the Panteion University, the University of Athens, the University of Piraeus, the University of Macedonia and the University of the Peloponnese. She is the author of several books in the fields of her expertise."
    },
    {
        ...
        role: "Session Chair",
        topic: "AI in Critical Infrastructures, Workshop: AI Services",
    ...
    },
    {
        ...
        photo: "biophotos/maximos-papakostas.jpeg",
        capacity: "Associate Professor, Hellenic Mediterranean University and ATHENA Research Center",
        role: "Panelist",
        topic: "AI in Culture and Heritage",
        cv: "Maximos Kaliakatsos-Papakostas is an Associate Professor in AI in Music and head of the Department of Music Technology and Acoustics, Hellenic Mediterranean University. He is also a collaborating faculty member at the ATHENA Research Center and the School of Music Studies, Aristotle University of Thessaloniki. His research interests concern computational creativity in machine learning models in the music domain. He has experience in participating and coordinating European and National research projects, in collaboration with universities in Greece and other European countries. He has also developed commercial audio and music applications, in collaboration with companies and artists in Greece and the USA."
    },
    {
        name: "Thomas-Nectarios Papanastasiou",
        photo: "biophotos/Thomas-Nektarios-Papanastasiou.jpg",
        capacity: "Assoc. Professor, University of Neapolis",
        role: "Panelist",
        topic: "AI and Challenges to Democracy",
        cv: "Thomas-Nektarios Papanastasiou is an Associate professor of public international law. He holds a doctorate (PhD), specialized in International Investment Law and a Masterâs degree (MA) in International Relations (Waseda University, Graduate School of Asian Pacific Studies). He also holds a Masterâs degree (LL.M) in Civil Procedure (Law School, University of Athens) and a law degree (LL.B) (Kapodistrian University of Athens). Dr. Papanastasiou is an attorney licensed to practice from the Athens Bar Association (since March 2005). He has worked for international organizations, as a consultant to the World Bank (WB, Washington DC), as a trainee at the Organization for Economic Cooperation and Development (OECD, Paris) and on a development program for the Japan International Co-operation Agency to Manila (Philippines). He has also worked as a researcher for Japanese organizations in Tokyo, the Waseda University Organization for Japan-US Studies (WOJUSS), the Mitsubishi Research Institute (MRI), and as a tutor for the Waseda University Writing & Research Centre. He is also a lecturer at the Police Academy of Cyprus."
    },
    {
        name: "Andreas Petridis",
    ...
    {
        name: "Constantinos Pitris",
        photo: "biophotos/constantinos-pitris.jpg",
        capacity: "Professor, University of Cyprus",
        role: "Session Chair",
        topic: "AI in Healthcare",
        cv: "Prof. Constantinos Pitris is currently a Professor at the KIOS Research and Innovation Center of Excellence, Department of Electrical and Computer Engineering, University of Cyprus. He is heading the âOptical Diagnostics Laboratoryâ which he established in 2004. Prof. Pitris has completed his studies at the University of Texas at Austin (BS Honors in Electrical Engineering, 1993, MS in Electrical Engineering, 1995), Massachusetts Institute of Technology (Ph.D. in Electrical and Medical Engineering, 2000), and Harvard Medical School (MD Magna Cum Laude in Medicine, 2002). His main research interests include the areas of optical diagnostics, biomedical imaging and spectroscopy, as well as signal/image analysis, machine learning and computational intelligence"
    },
    {
        ...
        role: "Session Chair, Panelist",
        topic: "AI in Higher Education, Emerging Research in AI",
    ...
    },
    {
        ...
        cv: "Michael Sailer is full professor for Learning Analytics and Educational Data Mining at University of Augsburg, Germany. Further he is academic director of the center of technology-enhanced learning and teaching at the University of Augsburg, Germany, and acts as Special Issue Editor for the journal âLearning and Individual Differencesâ. His research focuses on technology-enhanced learning and teaching. Specifically, the analyses of learning processes in digital learning environments and AI in education."
    },
    {
        name: "Eirini Schiza",
        photo: "biophotos/eirini-schiza.jpg",
        capacity: "Researcher, CYENS Centre of Excellence",
        role: "Panelist",
        topic: "AI in Healthcare",
        cv: "Dr. Eirini C. Schiza obtained a BSc in Computer Science from the University of Sussex in 2010 and MSc in Computer Science â Multimedia Applications and Virtual Environments from the University of Sussex in 2011. She is also obtained a PhD in Johan Bernoulli Institute for Mathematics and Computer Science of the University of Groningen. Her research interests are eHealth and supporting technologies, medical diagnostic systems, computational intelligence, multimedia applications and virtual environments."
    },
    {
        ...
        role: "Panelist",
        topic: "AI in Cybersecurity",
        cv: "Air Force Major Engineer Charalampos Sergiou is Officer in the Ministry of Defenceâs Directorate of Armaments and Defence Capabilities. He previously headed the Electronic Security Department of the Cyprus National Security Authority, focusing on national and EU cybersecurity and information assurance. He is also a Senior Researcher in the Department of Computer Science at both the University of Cyprus and the European University Cyprus. Charalampos holds a Degree in Electronics and Telecommunications Engineering from the Hellenic Air Force Academy, an MSc and PhD in Computer Science from the University of Cyprus, and a Masterâs Degree in Strategic Studies from the Aristotle University of Thessaloniki."
    },
    {
        name: "George Spyrou",
        photo: "biophotos/george-spyrou.png",
        capacity: "Professor, Head of the Bioinformatics Department, The Cyprus Institute of Neurology and Genetics",
        role: "Panelist",
        topic: "AI in Healthcare",
        cv: "Prof. George M. Spyrou is the ERA Chair and Head of the Bioinformatics Department at the Cyprus Institute of Neurology and Genetics (CING). He holds degrees in Physics, Medical Physics, and Bioinformatics, and a PhD in Medical Physics from the University of Patras. His research focuses on systems bioinformatics, multi-omics data integration, network analysis, and computational approaches for precision medicine."
    },
    {
        name: "Andreas Stavrou",
        photo: "biophotos/andreas-stavrou.jpg",
        capacity: "Assistant Manager, Electricity Authority of Cyprus Transmission System Owner Department",
        role: "Panelist",
        topic: "AI in Critical Infrastructures",
        cv: "Andreas Stavrou received his BSc in electrical engineering and MSc in power stations from Saint Peterburg State Technical University, in 1988 and 1990 respectively and his PhD from Aberdeen University in 1995. He joined the Electricity Authority of Cyprus in 1996, where now holds the position of Assistant Manager in the Transmission Substations, Construction, Protection and Maintenance department of the Transmission Network Ownerâs Unit. In the last nearly 30 years in his capacity as site engineer and project manager he handled a few tens of new transmission substation erection, testing and commissioning projects, upgrades, and extensions. Also, corrective maintenance activities, protection and SCADA systems testing.In the Transmission Network Ownerâs Unit he is now involved in New technology applications, Specifications, Project management, procurement, tenders, Transmission Grid Testing, maintenance and protection policies. Dr Stavrou participates in internally and externally funded Research Programs in collaboration with the University of Cyprus and other European partners on Power system related subjects."
    },
    {
    ...
    {
        name: "Marina Toumpouri",
        photo: "biophotos/marina-toumpouri.jpg",
        capacity: "Research Associate, CYENS CoE",
        role: "Panelist",
        topic: "AI in Culture and Heritage",
